...
4. **A REFUSED row is surfaced, never overridden.** For a **fixed** seat (chair, librarian, Third Place)
   the launch stops with the seat named, the reason printed, and the choice on screen. **`--retire-far`
   is the keeper's to type. Never automatic, for any seat.**
