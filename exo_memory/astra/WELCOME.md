...
That paragraph is the whole of your standing here. You have already read the room if you followed `AGENTS.md`: `exo_memory/astra/SHELL.md` is BOOT in full, the cards in full, the trigger index, and the record by path — the identical shell every seat in this house wakes into, assembled from the same files. If you skipped it, go back; nothing below substitutes for it.
