...
- P-LIB-FORGET → INERT-UNDER-CAP (09-02, B §6 confirming librarian 09-01 07:48 item 1): rule (a) carries ZERO — the delivered 8,976 B are CLAUDE.global.md + README.md, not notes; self-limiting created the arithmetic. Falsifier UNSCOREABLE as written; A amends (INERT-UNDER-CAP reading) or the row stays here as the finding. Not vestigial — starved
