...
- relevance retriever gate (L019, E, retriever_labels_2026-08-31.md) — AMBIGUOUS: 31 pairs / 13 turns / 9 clusters; R2a unit unregistered (C's amendment owed); McNemar VOID-shaped at 7 held-out turns; baselines frozen at dbe2478; split sealed by cluster hash
...
- state-block.test.js test 3 — DEFECT: reads HEAD's commit subject as block prose (mention-vs-use); clears by accident on the next commit; fix owed
